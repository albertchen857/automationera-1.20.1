...
public class TutorialMainScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ItemIconButton(
                ...
                btn -> this.client.setScreen(new TutorialGroupScreen("factory"))
        ));
        // 农场
        this.addDrawableChild(new ItemIconButton(
                ...
                btn -> this.client.setScreen(new TutorialGroupScreen("farm"))
        ));
        // 特殊
        this.addDrawableChild(new ItemIconButton(
                ...
                btn -> this.client.setScreen(new TutorialGroupScreen("special"))
        ));
    }
